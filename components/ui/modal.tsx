        ...
        >
          <div className="flex items-start justify-between p-6 border-b border-slate-800">
            <div>
              ...
              {description && (
                <Dialog.Description className="text-sm text-slate-400 mt-0.5">{description}</Dialog.Description>
              )}
            </div>
            <Dialog.Close className="p-1 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-slate-100 transition-colors">
              <X className="w-5 h-5" />
            </Dialog.Close>
          </div>
